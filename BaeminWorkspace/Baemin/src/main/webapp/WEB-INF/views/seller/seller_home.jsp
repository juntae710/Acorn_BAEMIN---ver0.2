...
<script>
    $(document).ready(function() {
		...
		function updataStoreHTML(d, s) {
		    ...
		    result += '<div class="store-plus-info"><span>매장사진</span><input name="upstoreImage" type="file" value="' + d.storeImage + '"></div>';
		    ...
		    result += '<div class="store-plus-but-wrap"><button class="store-plus-but" onclick="updateStore()">수정하기</button></div>';
		    result += '<input class="sstoreCode" type="text" value="' + s + '"></form>';
		    return result;
		}
			...
			<c:forEach items="${list }" var="item">
				<div class="store-list">
					<div class="store-img-wrap">
						<div class="store-img"><img alt="" src="/baemin/sellerHome/${item.storeImage }"></div>
					</div>
